This project performs comprehensive data analysis on CSV datasets including Facebook posts (fb_post.csv), Facebook ads (fb_ads.csv), and Twitter posts (tw_posts.csv). 
